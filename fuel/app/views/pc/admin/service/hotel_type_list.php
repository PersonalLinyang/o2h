...
<head>
	...
	<?php echo Asset::css('pc/admin/service/hotel_type_list.css'); ?>
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>
	<?php echo Asset::js('pc/admin/common.js'); ?>
	<?php echo Asset::js('pc/admin/service/hotel_type_list.js'); ?>
</head>
	...
	<div class="content-area">
			...
			<div class="div-content-list">
				...
				<table class="tb-content-list">
					...
					<tr>
						...
						<td><p class="btn-controller"><a href="/admin/modify_hotel_type/<?php echo $hotel_type['hotel_type_id']; ?>">修改名称</a></p></td>
		...
		<div class="popup-delete popup">
			...
			<div class="popup-content center">
				<p>酒店类别一经删除将无法还原，<br/>当酒店类别被删除时，使用该酒店类别的酒店将被设置为未设定，<br/>确定要删除「酒店类别-<span class="popup-delete-name"></span>」吗？</p>
			</div>
