				...
				<table class="content-form-talbe-col2">
					...
					<tr>
						...
						<td>
							...
							<label class="lbl-for-radio<?php echo $input_free_flag == '0' ? ' active' : ''; ?>" for="free-flag-0">收费</label>
							<input type="radio" name="free_flag" value="1" id="free-flag-1" <?php echo $input_free_flag == '0' ? '' : 'checked '; ?>/>
							<label class="lbl-for-radio<?php echo $input_free_flag == '0' ? '' : ' active'; ?>" for="free-flag-1">免费</label>
						</td>
					</tr>
					<tr>
						<th>票价</th>
							...
							<div id="spot-detail-area" data-detailnum="<?php echo count($input_detail_list) + 1; ?>">
								...
								<div class="spot-detail-block">
									<table>
										...
										<tr>
											<th>景点图片</th>
											<td class="spot-image-area">
												<div id="spot-image-area-<?php echo $input_detail['spot_sort_id']; ?>" data-imagenum="<?php echo count($input_detail['image_list']) + 1;?>">
												<?php if(count($input_detail['image_list'])): ?>
													...
													<div class="spot-image-block">
														<img class="thumb" src="/assets/img/tmp/<?php echo $_SESSION['login_user']['id']; ?>/spot/<?php echo $input_image; ?>">
													...
													<?php endforeach; ?>
												<?php else: ?>
													<div class="spot-image-area-thumb">
														<div id="thumb-<?php echo $input_detail['spot_sort_id']; ?>-0"></div>
														<div class="upload">
														<label>
												...
												<div id="spot-image-add-<?php echo $input_detail['spot_sort_id']; ?>" class="btn-spot-image-add" data-detailnum="<?php echo $input_detail['spot_sort_id']; ?>"><p>+</p></div>
											</td>
										</tr>
										<tr>
											<th>详情公开期</th>
											<td>
												...
												<label for="two-year-flag-<?php echo $input_detail['spot_sort_id']; ?>">跨年</label>
