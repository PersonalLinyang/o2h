		...
		<div class="content-main">
			...
			<form method="post" action="" class="content-form">
				<table class="tb-content-form">
					<tr>
						<th>收入项目名</th>
						<td><input type="text" name="income_type_name" value="<?php echo $input_income_type_name; ?>" maxlength="50" placeholder="请输入收入项目名(50字以内)" /></td>
					</tr>
					<tr>
						<td colspan="2">
							<ul class="button-group">
								<li class="button-yes btn-form-submit">保存</li>
								<li class="button-no"><a href="/admin/income_type_list/">取消</a></li>
							</ul>
						</td>
					</tr>
				</table>
