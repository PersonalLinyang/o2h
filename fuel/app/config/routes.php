...
return array(
	...
	'admin/modify_master_group/(:group_id)'  => 'admin/user/modifymastergroup/index/$1',
	'admin/modify_sub_group/(:group_id)'     => 'admin/user/modifysubgroup/index/$1',
	'admin/modify_function/(:function_id)'   => 'admin/user/modifyfunction/index/$1',
	'admin/modify_authority/(:authority_id)' => 'admin/user/modifyauthority/index/$1',
